                            ...
                            <tbody className="text-center" id="havaleTable">
                                {Shipping ? Shipping.map(item =>
                                    ...
                                    <tr key={item.id} id={item.orderDetailId} onClick={()=>findeTakhsis(item.orderDetailId)}>
                                        ...
                                        <td bgcolor="transparent">{item.shippingContractCode ? item.shippingContractCode : '--'}</td>
                                        <td bgcolor="transparent">{item.shippingCompanyName ? item.shippingCompanyName : '--'}</td>
