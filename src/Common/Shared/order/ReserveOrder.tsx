...
const ReserveOrder: React.FC<Props> = ({ id, modalIsOpen, closeModal }) => {
    const [loading, setLoading] = useState(false);
    const [comment, setComment] = useState('')
    const [reservationExpireDate, setreservationExpireDate] = useState<any>()
    ...
    return (
        ...
        >
            ...
            <div >  
                <div className="card-body p-0" style={{ height: '25rem', width: '30rem' }}>
                    <div className="mb-4 ">
                        ...
                        <p>در نظر داشته باشید با تغییر نوع سفارش به رزرو ، مبلغ تمام شده سفارش بر اساس تخصیص به آن سفارش ارزیابی خواهد شد و صدور صورتحساب بر اساس هر تخصیص امکان پذیر می باشد.
                            همچنین پیشنهاد میگردد به دلیل جلوگیری از بروز هرگونه مشکل نسبت به تعهد صورت گرفته، تاریخ انقضا آن نظر بگیرید تا از ثبت آدرس توسط مشتری پس از تاریخ اعتبار تعهد جلوگیری گردد.
