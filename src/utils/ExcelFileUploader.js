...
const ExcelFileUploader = ({ EntityTypesId, EntityId, modalIsOpen, closeModal,comment }) => {
...
<Fragment>
        ...
        <ExcelFilePreviewer modalIsOpen={ShowResultModal} data={data} closeModal={setShowResultModal}  scondeModalClose={closeModal} orderDetailId={EntityId}/>
        </Fragment>
    )
}
