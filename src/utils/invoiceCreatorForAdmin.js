...
const InvoiceCreatorForAdmin = ({ closeModal }) => {
  ...
  useEffect(() => {
    function adjustZoom() {
      ...
      if (roles.every((i) => i >= 2)) {
        ...
        document.getElementsByClassName("a4")[0].style.transform =
          "scale(" + zoomLevel + ")";
      }
    }
  ...
  const Fullname = () => {
    ...
    if (customer.organizationId !== null) {
      OName = organizations
        .filter((item) => item.id === customer.organizationId)
        .map((item) => item.name);
      ...
      <div id="body" className="a4  rounded-5">
        <div ref={ref} className=" page">
          ...
          >
            <p>
              {" "}
              تاریخ {""}:{""}{" "}
              {new Date(order.createDate).toLocaleDateString("fa-IR", {
                year: "numeric",
                month: "2-digit",
                day: "2-digit",
              })}
          ...
          <div className="containBox  ">
            ...
            <div className="small  info-border p-1">
              <div className="row">
                <div className="col-6">
                  <p>
                    نام شخص حقیقی/حقوقی {""}:{""} شرکت روغنکشی نوید خلیج فارس
                  </p>
                </div>
                <div className="col-3">
                  <p>
                    شماره اقتصادی {""}:{""} 411145758678{" "}
                  </p>
                </div>
                <div className="col-3">
                  <p>
                    شماره ثبت/شماره ملی{""}:{""} 10102197112
                  </p>
                </div>
              </div>
              <div className="row">
                <div className="col-6">
                  <p>
                    نشانی {""}:{""} بلوارآفریقا - کوچه گلخانه پلاک 14{" "}
                  </p>
                </div>
                <div className="col-3">
                  <p>
                    کد پستی ده رقمی {""}:{""} 1915873145{" "}
                  </p>
                </div>
                <div className="col-3">
                  <p>
                    شماره تلفن/نمابر {""}:{""} 0212852/22042519
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="small info-border p-1">
              ...
              <div className="row">
                <div className="col-6">
                  <p>
                    نشانی {""}:{""}{" "}
                    {Address.length !== 0 ? Address[0].fullAddress : ""}
                  </p>
                </div>
                <div className="col-3">
                  <p>
                ...
                <div className="col-3">
                  <p>
                    {" "}
                    شماره تلفن/نمابر {""}:{""} {customer.userName}
                  </p>
                </div>
              </div>
            </div>
            <div>
              ...
              <div className="w-100">
                <table
                  className="w-100  table-bordered  text-sm-center small h-auto "
                  style={{ width: "100%" }}
                >
                  <thead>
                    <tr>
          ...
          <div className="text-center mt-5 mb-5 " style={{ lineHeight: "30%" }}>
            <p>
              {" "}
              لطفا وجه پیش فاکتور فوق را به شماره حساب بانک شهر 1001001300991 و
              شبا IR930610000001001001300991 یا شماره حساب بانک
            </p>
            <p>
              کشاورزی 995251962 و شبا IR150160000000000995251962 واریز نمایید.
            </p>
          </div>
          <div
            className="end-part-invoice"
            style={{
              marginTop: "100px",
              marginLeft: "2.5%",
              marginRight: "2.5%",
          ...
          >
            <div className="row   small ">
              <div className="col-6" style={{ border: " 1px solid black" }}>
                <div className="row">
                  <div className="col-6 ">شرایط یا نحوه فروش</div>
                  <div className="col-3">نسیه</div>
        ...
        <div className="row">
          <button
            ...
            className="btn btn-danger col-lg-5   mb-2 "
          >
            بازگشت
          </button>
              ...
              <>
                ...
                <button
                  onClick={function () {
                    document.getElementsByClassName("a4")[0].style.transform =
                      "scale(1 )";
                    document.getElementsByClassName("page")[0].style.width =
                      "29.7cm";
                    document.getElementsByClassName("page")[0].style.height =
                      "21cm";
                  ...
                  className="btn btn-info  float-left  col-lg-5  mb-2  "
                >
                  دریافت فایل پی دی اف{" "}
                </button>
                <br />
                <h4 className="col-12 text-danger w-75 text-center mb-4">
                  مشتری گرامی : لطفا پس از دانلود فایل پیش فاکتور ، اقدام به چاپ
                  آن نمایید ، سپس بوسیله مهر و امضا لازمه پیش فاکتور را را تایید
                  نموده و در آخر تصویر اسکن شده آن را از بخش آپلود فایل برای ما
                  ارسال نمایید{" "}
                </h4>
              </>
            )}
