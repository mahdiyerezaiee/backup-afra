...
const NewsList = () => {
    ...
    const columns = useMemo(() => [
        ...
        , {
            Header: 'عملیات', accessor: '', Cell: row => (<button onClick={() => openModal(row.row.original.id)} className="border-0 bg-transparent non-hover edit-btn">
                ...
                <div className=" statbox widget-content widget-content-area">
                    ...
                    >
                        <div style={{width:"20rem"}}>
                            ...
                            {guessNews.filter(item => item.id === id).map((item) =>
                    ...
                    <div>
                        <MyTable bulkJob={getBulkJob} setPageNumber={setPageNumber} setPageSize={setPageSize}  PageSize={PageSize} total={totalCount} PageNumber={PageNumber} columns={columns} data={data} getData={rows => setSelectedRows(rows)} getDataBySearch={getDataByPage} />
