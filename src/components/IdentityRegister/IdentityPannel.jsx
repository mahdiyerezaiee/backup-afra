    ...
    return (
        <div className='user-progress'>
            ...
            <div className='boxrow' >
                <Link to='/personidentity'  className="m-auto rounded" style={{ color: user.nationalCode ? " green": " lightcoral", border: user.nationalCode ? " 1px solid green": " 1px solid lightcoral" , animation:user.nationalCode ? "none":"pulsered 2s infinite" }} >
