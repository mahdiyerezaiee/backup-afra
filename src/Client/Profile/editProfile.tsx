    ...
    return (
        ...
        <div className="  layout-px-spacing">
            ...
            <div className='mt-5 mx-auto p-5 dashboard-widget bg-light rounded row d-flex justify-content-center col-12'>
                {roles.includes(1) ? <div className="text-center  rounded border-bottom border-danger">

                    <h6 className="text-danger ">*لطفا جهت استفاده از سایر امکانات سامانه اطلاعات کاربری خود را تکمیل کنید*</h6>
                </div> : ''}
